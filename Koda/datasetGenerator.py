...
if __name__ == "__main__":
    ...
    directions = {
        ...
        "nasmeh": (base_output_dir + "/Smeri/nasmeh.npy", (0, 10)),
        "očala": (base_output_dir + "/Smeri/ocala.npy", (0, 10)),
        "blond": (base_output_dir + "/Smeri/blond.npy", (0, 8)),
        "rotacija": (base_output_dir + "/Smeri/rotacija.npy", (30, 180)), # 10, 150
        "rasa črna": (base_output_dir + "/Smeri/rasa_crn.npy", (0, 3)),
        "rasa kitajska": (base_output_dir + "/Smeri/rasa_chn.npy", (0, 10)),
        "spol": (base_output_dir + "/Smeri/spol.npy", (0, 20))
    }
    ...
    for i in range(1, num_people + 1):
        ...
        base_image_path = os.path.join(person_dir, "image.png")
        base_latent_path = os.path.join(person_dir, "latent_vector.txt")
        ...
        for j in range(1, num_variations + 1):
            ...
            variation_image_path = os.path.join(person_dir, f"variation_{j}.png")
